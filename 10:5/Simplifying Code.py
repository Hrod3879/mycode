# mock code that needs to be simplified
# def main():    
...
# my simplified version of the Chinese Zodiac program
  
def main():
    usr_name = input("Please enter your name:\n>").title()
    usr_date = int(input("Please enter your birth year in YYYY format, e.g 2010:\n>"))
    sign = (usr_date - 1924) % 12  # Adjust for the starting year (1924) of the Chinese zodiac
    zodiac = [
    ...
    print(f"{usr_name}, your zodiac sign is {zodiac[sign]}.")

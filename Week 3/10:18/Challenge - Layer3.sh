...
# Add root namespace iptables destination NAT for ens3:5555 to 10.64.10.2:80
iptables -t nat -A PREROUTING -i ens3 -p tcp -m tcp --dport 5555 -j DNAT --to-destination 10.64.10.2:80
